            ...
            <table class="table table-bordered">
              ...
              <tbody>
               ...
               ?>              
                  ...
                  <td><a class="btn btn-primary" href="EditOffers.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                  <td><a class="btn btn-danger" href="DeleteOffers.php?id=<?php  echo $row['id']; ?>">Delete</a></td>
                </tr>
                <?php  } ?>
              </tbody>
            </table>
...
if(isset($_POST['submit'])){
    ...
    $desc=$_POST['desc'];
    $price=$_POST['price'];
    $res=mysqli_query($conn,"insert into offers values(NULL,'$folder','$desc','$price')");
    if($res){
    ?>
    <script>
